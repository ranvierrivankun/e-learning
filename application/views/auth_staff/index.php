               ...
               <div class="card auth-card">
                  <div class="card-body p-0">
                     <div class="d-flex align-items-center auth-content">
                        <div class="col-lg-6 bg-success content-left">
                           <div class="p-3">
                              <h2 class="mb-2 text-white">Login Staff <?= $nama_sekolah ?></h2>
                              ...
                              <p>
                                 ...
                                 <form method="post" action="<?= base_url('auth_staff'); ?>">
                                    <div class="row">

                                      <div class="col-lg-12">
                                       <div class="floating-label form-group">
                                          <input class="floating-input form-control" type="number" name="nik" placeholder=" ">
                                          <label>NIK</label>
                                       </div>
                                    </div>
