    ...
    <div class="modal-body">
        ...
        <div class="row">
            <div class="col mb-1">
                ...
                <input type="text" name="nama_kelas" class="form-control" value="<?= $edit->nama_kelas ?>">
            </div>
        </div>
        ...
        <div class="row">
            <div class="col mb-1">
                ...
                <select class="form-control kejuruan" name="kejuruan" required>
                    <option value="<?= $edit->kejuruan ?>"><?= $edit->nama_kejuruan ?></option></select>
                </select>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    $(".kejuruan").select2({
        theme: 'bootstrap4',
        dropdownParent: $("#modal_edit_data_kelas"),
...
/*Proses Edit Data Kejuruan*/
    $('#form_edit').on('submit', function(e) {
        ...
        Swal.fire({
            ...
            if(result.value) {
                $.ajax({
                    url: "<?= site_url('pengaturan_kelas/proses_edit_data_kelas')?>",
                    method: "POST",
                    ...
                    success: function(data){
                        ...
                        if(data.status == true) {
                          Swal.fire({
                            ...
                            $('#modal_edit_data_kelas').modal('hide');
                        });
                    } else {
                      Swal.fire({
                        icon: "error",
