                  ...
                  <div class="card">
                     <div class="card-header d-flex justify-content-between">
                        <div class="header-title">
                           <h4 class="card-title">Laporan Absensi Kelas <?= $head->nama_kelas ?> - <?= $head->nama_kejuruan ?></h4>
                        </div>
                     </div>
                     <div class="card-body" id="header">
                        ...
                        <div class="btn-group col-lg-2 mb-2">
                          ...
                          <form action="<?= site_url('laporan/table_absensi_excel') ?>" method="post" enctype="multipart/form-data" accept-charset="utf-8">
                   ...
                   <div id="table_laporan_absensi"></div>
...
<script type="text/javascript">
  ...
  $.ajax({
     url: "<?= site_url('laporan/table_laporan_absensi') ?>",
     method: "POST",
     data: requestData,
     ...
     beforeSend: () => {
      ...
      $('#table_laporan_absensi').html(`<i class='fa-solid fa-spinner'></i> Memproses`);
   },

   success: (data) => {
      $('#btn-filter').html(`<i class='fa fa-filter'></i> Filter`);
      $('#btn-filter').attr('disabled', false);
      $('#table_laporan_absensi').html(data);
   },
