    <form method="POST" id="form_nilai_update" enctype="multipart/form-data">
        ...
        <div class="modal-body">
            ...
            <div class="row">
                ...
                <div class="col-6 mb-1">
                    ...
                    <textarea type="text" name="catatan_tugas" class="form-control"></textarea>
                </div>
            </div>
        ...
        <div class="modal-footer">
           ...
           <button type="submit" class="btn btn-primary" id="saving">Nilai</button>
       </div>
   ...
   <script type="text/javascript">
     /*Proses Nilai Tugas*/
    $('#form_nilai_update').on('submit', function(e) {
        e.preventDefault();
        ...
        Swal.fire({
            ...
            if(result.value) {
                $.ajax({
                    url: "<?= site_url('Jadwal_mengajar/proses_nilai_tugas')?>",
                    method: "POST",
                    ...
                    success: function(data){
                        ...
                        if(data.status == true) {
                          Swal.fire({
                            ...
                            icon: "success",
                            title: "Berhasil",
                            text: "Tugas Berhasil Dinilai!",
                            timer: 1500,
                        }).then((e)=> {
                            $('#table_data_upload').DataTable().ajax.reload(null, false);
                            $('#modal_nilai_tugas').modal('hide');
                        });
                    } else {
                      Swal.fire({
                        icon: "error",
